...
public class SipHash_2_4 {
     ...
     * <p>
     * The bytes are accumulated until there are 8 of them and then the corresponding long
     * (read from the bytes as LittleEndian format) is added to the hash
     *
     ...
     * <p>
     * This method returns the hash as long. Use one of the utility methods, longToByteLE or
     * longToByte to convert the long to bytes in LittleEndian or BigEndian format respectively
     * and then use toHex to convert the byte[] to a string of hex digits for display or
     * transmission.
     *
